...
import Logo from '../../assets/images/doctorino/LOGOMARK DARK.png'
      ...
      >
        ...
        >
          ...
          >
            <a
              href=""
              className="flex items-center duration-300  group-[.side-menu--collapsed.side-menu--on-hover]:xl:ml-0"
            >
              <img width={30} src={Logo} alt="logo" />
              <div className="ml-4 font-bold text-1.5xl group-[.side-menu--collapsed.side-menu--on-hover]:xl:opacity-100 group-[.side-menu--collapsed]:xl:opacity-0 transition-opacity">                QUICK CARE
              </div>
            </a>
            <a
              href=""
